...
from utils_dataset import get_transform_torch_img
...
"""
"DataLoader" for all plot images
Loads images based on random idx; 
number of images defines number of images loaded for evaluation
(change number of images by hand)
"""
...
"""
OVERLAPS ARE DEFINED HERE; 
step_size_width = 120   -> vertical overlap
step_size_heigth = 240  -> horizontal overlap

change parameter "intersection" to false, if you don't want to remove duplicates using intersection

main computation of image plots
returns results as list of plot results
"""
def main(model, image_list, score_threshold, iou_threshold, mask_threshold, intersection):
    ...
    for image in image_list:
        ...
        predictions = remove_overlapping_boxes(predictions, iou_threshold, intersection)
...
if __name__ == "__main__":
    ...
    start = time.time()
    results = main(model, images_list, score_threshold, iou_threshold, mask_threshold, intersection=True)
    end = time.time()
    print("")
